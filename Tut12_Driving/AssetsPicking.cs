...
namespace Fusee.Tutorial.Core
{
    public class AssetsPicking : RenderCanvas
    {
        ...
        private TransformComponent _SchaufelTransform;
         private TransformComponent  _Body2Transform;
        ...
        public override void RenderAFrame()
        {
           ...
           // _SchaufelTransform.Scale = new float3(0.5f, 2f, 2f);
            ...
            float speed = Keyboard.WSAxis * 0.8f;
            float rotSpeed = Keyboard.ADAxis * 2.0f;
            float wheelRotSpeed = speed * 5 * DeltaTime;
            float deltaWheelRotSpeed = rotSpeed * 2 *Time.DeltaTime;
            float x_Rot = _BodyTransform.Rotation.x + rotSpeed * Time.DeltaTime;
            float y_Rot = _BodyTransform.Rotation.y + rotSpeed * Time.DeltaTime;
            float3 speed3D = new float3(speed * M.Cos(x_Rot),speed * M.Sin(x_Rot), 0 );

            _BodyTransform.Translation = _BodyTransform.Translation + speed3D * Time.DeltaTime;
            _BodyTransform.Rotation = new float3(_BodyTransform.Rotation.x, y_Rot,  _BodyTransform.Rotation.z );
          
            

            
            _WheelHRTransform.Rotation = new float3(0, 0,_WheelHRTransform.Rotation.z + wheelRotSpeed - deltaWheelRotSpeed);
            _WheelHLTransform.Rotation = new float3(0, 0,_WheelHLTransform.Rotation.z + wheelRotSpeed - deltaWheelRotSpeed);
            _WheelVRTransform.Rotation = new float3(0, 0,_WheelVRTransform.Rotation.z + wheelRotSpeed - deltaWheelRotSpeed);
            _WheelVLTransform.Rotation = new float3(0, 0,_WheelVLTransform.Rotation.z + wheelRotSpeed - deltaWheelRotSpeed);
