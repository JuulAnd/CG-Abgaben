...
namespace Fusee.Tutorial.Core
{
    public static class SimpleMeshes 
    {
        ...
        public static Mesh CreateCylinder(float radius, float height, int segments)
        {
            ...
            //top triangle
            tris[12*(segments) - 1] = (ushort) (4*segments);  // center point
